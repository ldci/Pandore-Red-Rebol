...
sldSize: as-pair ((dSize * 3) - 150) 16
...
view win: layout [
		...
		cb: check 100 "Show Pandore" false	[if isFile [process]]
		button 250 "Remove Temporary Pandore Images"	[removePanImg]	
		pad 225x0		
		button 70 "Quit" 					[Quit]
		return
		text 100 "Low Threshold" 
